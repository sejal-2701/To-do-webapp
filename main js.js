window.addEventListener('load', () => {
    ...
    e.preventDefault();
        ...
        if (!product) {
            alert("Please fill out the product");
            return;
        }
        ...
        const product_qualities_el = document.createElement('div');
        product_qualities_el.classList.add('qualities');
        ...
        product_edit_el.innerText = 'Delete';

        product_qualities_el.appendChild(product_edit_el);
        product_qualities_el.appendChild(product_delete_el);

        product_el.appendChild(product_qualities_el);
